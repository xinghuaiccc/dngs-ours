...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, inference=False, override_color=None, return_contrib=False):  # [ADD] override_color for semantic render
    """
    Render the scene. 
    ...
    if override_color is not None:  # [ADD]
    ...
    # Ashawkey version
    rendered_image, radii, rendered_depth, rendered_alpha, contrib = rasterizer(
        means3D=means3D,
        means2D=means2D,
        shs=shs,
        ...
        return_contrib=return_contrib,  # [ADD]
    )
    ...
    return {"render": rendered_image,
            ...
            "contrib": contrib if return_contrib else None}  # [ADD]
